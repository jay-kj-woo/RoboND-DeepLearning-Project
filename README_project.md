...
It does this by replacing CNN's fully connected layer with 1x1 convolutional network. 
Fully connected layer 
The tasks for scene understanding comprise of identifying the moving target and locating the target in the given scene. 
